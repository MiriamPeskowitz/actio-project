  ...
  Citizen.create(:username => "Hilary", :email => "Hilary@mail.com", :password_digest => "dog!!")
  Citizen.create(:username => "Mark", :email => "mark@mail.com", :password_digest => "dog!!" )
  Citizen.create(:username => "Chad", :email => "Chad@mail.com", :password_digest => "dog!!" )
